...
export const  EditPostMutation = ()=>{
    ...
    const {mutate, isLoadingMutation, isError} = useMutationRequest(EditPostService, {name:'posts'})

    return {mutateEdit:mutate, isLoadingMutationEdit:isLoadingMutation, isErrorEditPost:isError}
